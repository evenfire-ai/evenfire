                            ...
                            <RowActionsMenu
                              ...
                              actions={[
                                ...
                                },
                                {
                                  ...
                                  // Pass the whole row, not (name, namespace): the delete is
                                  // fenced on the live object's uid + resourceVersion, which
                                  // only the row carries. Reducing it to two identifier strings
                                  // would drop the CAS precondition and let the request delete a
                                  // Secret that was replaced since the table was loaded.
