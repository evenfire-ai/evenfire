 ...
 * file is already known to be larger than the thumbnail budget; the
 * resolved blob is re-checked after fetch so oversized files don't
 * sneak through on stale metadata.
 */
