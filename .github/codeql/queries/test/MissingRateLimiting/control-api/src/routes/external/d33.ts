...
import { requireExternalSessionLimiterIdentityWithPublicErrors as requireWrongStageA } from "../../middleware/unrelatedMiddleware";
...
async function protectedAsyncWork(
