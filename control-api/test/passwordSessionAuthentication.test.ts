...
describe('password session issuance serialization', () => {
  ...
  it('does not issue when a password change commits after verification but before the row lock', async () => {
  ...
  it('issues through the same locked transaction when the credential is still current', async () => {
