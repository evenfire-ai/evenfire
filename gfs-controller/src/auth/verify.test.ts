...
function v2Authority(iat: number, exp: number) {
  return {
    binding: {
      version: 2,
      ...
      sessionVersion: 1,
      delegationJti: '55555555-5555-4555-8555-555555555555',
      operationId: 'gfs.read',
      resource: {
        environmentId: 'development:local-cluster',
        type: 'gfs_resource',
        canonicalId: 'gfs_resource:66666666-6666-4666-8666-666666666666',
        logicalId: '66666666-6666-4666-8666-666666666666',
        displayName: 'document',
      },
      target: { drive: 'main', resourceId: '66666666-6666-4666-8666-666666666666' },
    ...
    sourceIssuedAt: iat - 1,
    sourceExpiresAt: exp - 1,
  }
}
...
describe('verifyGfsToken', () => {
  ...
  it('accepts complete v2 provenance issued before its filesystem wrapper', () => {
