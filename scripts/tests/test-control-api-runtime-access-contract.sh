...
grep -Fq "('UPDATE', expected.access_profile IN ('legacy_dml', 'upsert'))" "$MIGRATION_SCRIPT"
grep -Fq "('DELETE', expected.access_profile IN ('legacy_dml', 'link_lifecycle'))" "$MIGRATION_SCRIPT"
