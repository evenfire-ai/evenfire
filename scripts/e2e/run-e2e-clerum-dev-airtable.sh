#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════
# E2E Runner — clerum-dev (GKE) Airtable registry + XLSX report suite
# ═══════════════════════════════════════════════════════════════════════
#
...
#                        (default: gke_${GCP_PROJECT}_us-central1-a_clerum-dev)
...
log()  { printf '[e2e-clerum-dev-airtable] %s\n' "$*" >&2; }
die()  { printf '[e2e-clerum-dev-airtable] ERROR: %s\n' "$*" >&2; exit 1; }
