...
/**
 * D5 (#739): peak RSS with eight 8 MiB streams, two 24 MiB visual streams and
 * three queued 8 MiB bodies, heap capped at 384 MiB (tsc build, one process).
 */
const D5_CAPPED_PEAK_RSS_MIB = 790.3
