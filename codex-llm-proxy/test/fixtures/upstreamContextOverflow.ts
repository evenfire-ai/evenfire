...
// model's context window, transcribed by hand from the recorded trace: a
// `codex exec` 0.154.0 run on 2026-09-23 against `gpt-5.6-luna` over HTTPS
// (1,040,000 CJK characters of input). Only these events are transcribed, so
// no message text or account data is kept. #731: the proxy used to discard the
// code and answer 503.
