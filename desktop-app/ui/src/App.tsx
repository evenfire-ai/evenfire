...
export function App() {
  ...
  const authValue = React.useMemo(
    () => ({
      ...
      identityProviders: vm.identityProviders,
      identityProvidersLoading: vm.identityProvidersLoading,
      ...
      handleMicrosoftIdentityProviderLogin: vm.handleMicrosoftIdentityProviderLogin,
    ...
    [
      ...
      vm.handleMicrosoftIdentityProviderLogin,
