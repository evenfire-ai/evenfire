...
import type { GfsInheritedAccessSource } from '../delegation.types'
import {
...
const subjectArb = fc.record({
  ...
  id: fc.option(fc.string({ minLength: 1, maxLength: 8 }), { nil: undefined }),
})
...
describe('inheritedAccessMerge properties', () => {
