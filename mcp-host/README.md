...
| `CLERUM_ATTACHMENT_FILE_MAX_BYTES`      | Maximum decoded size in bytes of one incoming `kind:'file'` attachment; a larger file rejects the message with `FILE_ATTACHMENT_TOO_LARGE`. An invalid value stops the Host at startup.                                                                                                                                                                      | `CLERUM_ATTACHMENT_FILE_MAX_BYTES=3145728`                                                                                                                                                         |
