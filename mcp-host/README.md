...
| `CLERUM_MCP_TOOL_TIMEOUT_MS`           | Per-call timeout passed to MCP SDK `Client.callTool(...)` requests. The effective timeout is still bounded by any caller workflow or snippet step budget.                                                                                                                                                 | `CLERUM_MCP_TOOL_TIMEOUT_MS=660000`                                                                                                                                                                |
| `CLERUM_MCP_TOOL_MAX_TOTAL_TIMEOUT_MS` | Maximum total MCP SDK tool-call budget used at the SDK request boundary. Operators may tune it up to the existing workflow step ceiling; invalid values fail closed at runtime.                                                                                                                           | `CLERUM_MCP_TOOL_MAX_TOTAL_TIMEOUT_MS=660000`                                                                                                                                                      |
...
| `CLERUM_AGENT_MAX_TASK_DURATION`       | Configured duration in milliseconds (5 hours); the current TaskExecutor does not enforce this deadline.                                                                                                                                                                                                   | `CLERUM_AGENT_MAX_TASK_DURATION=18000000`                                                                                                                                                          |
