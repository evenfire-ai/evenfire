...
| `HCC_AUTHORITY_MAX_STALENESS_MS`       | Maximum time a previously published MCP fleet may survive without a fresh authenticated HCC snapshot. It is capped at 60000 ms and must be greater than `CLERUM_CONTEXT_MAPPER_POLL_INTERVAL` in cluster mode; invalid combinations fail startup.           | `HCC_AUTHORITY_MAX_STALENESS_MS=60000`                                                                                                                                                             |
