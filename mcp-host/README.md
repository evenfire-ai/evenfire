...
| `CLERUM_MCP_SERVERS`                   | Supplies dev MCP server definitions as JSON so you can run without context mapper.                                                                                                                                               | `CLERUM_MCP_SERVERS=[{"name":"filesystem","transport":{"type":"streamableHttp","url":"http://localhost:3101"}}]`                                 |
