...
describe('searchWorkspace', () => {
  ...
  it('scores full match higher than partial match', async () => {
    await fs.writeFile(path.join(tmpDir, 'full.md'), 'The API design decisions were documented.')
    await fs.writeFile(path.join(tmpDir, 'partial.md'), 'The API endpoint was created last week.')
  ...
  it('applies recency boost to daily log files', async () => {
    ...
    await fs.writeFile(path.join(tmpDir, 'notes.md'), 'The deployment was successful.')
  ...
  it('applies identity boost to MEMORY.md', async () => {
    await fs.writeFile(path.join(tmpDir, 'MEMORY.md'), 'Database schema finalized.')
    await fs.writeFile(path.join(tmpDir, 'other.md'), 'Database schema finalized.')
