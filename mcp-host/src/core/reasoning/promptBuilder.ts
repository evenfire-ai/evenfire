...
export const WORKFLOW_RECIPES_TEXT =
  ...
  'If the user asks a vague follow-up such as check progress, status, did it finish, or what happened after a recent `workflow_trigger`, use the same workflow recipe name from that trigger and do not switch to unrelated task-board, dashboard, CRM, or MCP tools unless the user explicitly names that separate system. ' +
