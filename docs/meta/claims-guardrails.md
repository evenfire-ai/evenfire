...
| “Any model” / every provider under the sun              | The 24 canonical providers (README table); OpenAI-compatible entries are config                                |
| A provider outside the shared package as shipped        | Only the 24 ids in `packages/llm-providers/index.cjs` ([overview](../llm-providers/README.md))                 |
