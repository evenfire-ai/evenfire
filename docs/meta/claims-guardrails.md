...
| “Any model” / every provider under the sun              | The 22 canonical providers (README table); OpenAI-compatible entries are config                                |
| A provider outside the shared package as shipped        | Only the 22 ids in `packages/llm-providers/index.cjs` ([overview](../llm-providers/README.md))                 |
