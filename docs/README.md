...
| Doc                                                     | Description                                                                                                |
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [LLM providers overview](llm-providers/README.md)       | The 21 supported providers; the provider / model / credential model, request flow, allowlist, and fallback |
| [Operator guide](deploy/llm-providers.md)               | Configure credentials (incl. Vertex and Bedrock) and the model allowlist                                   |
| [Adding a provider](llm-providers/adding-a-provider.md) | Data-only (OpenAI-compatible) vs driver-based, and the single source of truth                              |
...
| Pick or configure an LLM provider    | [LLM providers](llm-providers/README.md)                 |
